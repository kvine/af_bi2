defmodule DB.WriteAFToESFlag do 
    ...
    @table_name BI.Global.db_table_name_write_af_to_es_flag()
    
    # DB.WriteAFToESFlag.create_table()
    def create_table() do 
    ...
    # DB.WriteAFToESFlag.get_item("cc64a6a9-1e34-4352-afa4-f6a4ef2fbf98","1637567587873-866860313320110626")
