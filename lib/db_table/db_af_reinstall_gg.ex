defmodule DB.AFReinstallGG do 
    ...
    @table_name BI.Global.db_table_name_reinstall_gg()
    ...
    # DB.AFReinstall.get_items_with_install_time("cc64a6a9-1e34-4352-afa4-f6a4ef2fbf981",10)
